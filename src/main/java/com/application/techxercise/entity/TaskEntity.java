...
public class TaskEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(title, that.title) && Objects.equals(description, that.description) && status == that.status && priority == that.priority && Objects.equals(author, that.author) && Objects.equals(executor, that.executor) && Objects.equals(commentsCreated, that.commentsCreated);
    }
